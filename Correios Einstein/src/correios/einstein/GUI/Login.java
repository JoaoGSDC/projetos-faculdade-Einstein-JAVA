...
import correios.einstein.DAO.LoginDAO;

import correios.einstein.GUI.NewUserGUI;
...
public class Login extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ResultSet rs = loginDAO.consultar(txtUsername.getText(), txtPassword.getText());
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        NewUserGUI frmNewUserGUI = new NewUserGUI();

        frmNewUserGUI.setVisible(true);
        dispose();
